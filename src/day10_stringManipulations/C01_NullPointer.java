...
public class C01_NullPointer {
    public static void main(String[] args) {
         ...
         */
        str4 = null;
        // System.out.println(str4.length());          // NullPointerException:olusturuldu ama deger atanmadi!
        ...
        System.out.println(str4.concat("Ali Can")); // NullPointerException: yani null olarak isaretlenmis degeri metodlarla kullandirmiyor.

        /*
        nerde kullanilir: kullanici metodu yanlis kullandiginda, "return null" olsun istersin, boslukla yapilamiyor.
        null isaretlenmis deger, metodlarla kullanirsan NullPointerException verir, bunu bil simdilik.
         */
