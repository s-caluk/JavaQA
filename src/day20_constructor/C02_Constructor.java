...
public class C02_Constructor {
    public static void main(String[] args) {
        ...
        /*diyelim 4 parametreli cont. yok. code>generate>contruktor+strg ile parametreleri sec>ok
        dedigin zaman ilgili classa otomatik cont. olusturuluyor! car3 de bunu denedik.
         */
        /*
        Car{marka='Toyota'
        , model='Corolla'
