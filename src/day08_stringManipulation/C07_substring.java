...
public class C07_substring {
    public static void main(String[] args) {
        ...
        System.out.println(str.substring(5,5)); // hiclik yazdirir yani konsolda bos bir satir olusur, hata vermez


        // System.out.println(str.substring(4,3)); // StringIndexOutOfBoundsException - hata

        // System.out.println(str.substring(25,28)); // StringIndexOutOfBoundsException - hata

        System.out.println(str.substring(str.length())); // hiclik yazdirir
        // System.out.println(str.charAt(str.length())); // StringIndexOutOfBoundsException - hata
        // System.out.println(str.substring(str.length()+1)); // StringIndexOutOfBoundsException - hata
        System.out.println("=======");
    }
}
