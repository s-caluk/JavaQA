...
public class C06_SifreKontrolu {
    public static void main(String[] args) {
        ...
        while (tekrarSifreIste) {
            ...
            if (sifreKontrolEt(sifre)) {      //sifre kontrolu true dönerse basarili demektir
                System.out.println("basari ile olusturuldu");
                break;
                //tekrarSifreIste = false;      //break ya da bu kod calisir.yani basarilmistir.
            }
        }
    }
    ...
    public static boolean sifreKontrolEt(String sifre) {
        ...
        if (!(sifre.charAt(0) >= 'a' && sifre.charAt(0) <= 'z')) {
            ...
            // sifre.charAt(0)<'a' || sifre.charAt(0)>'z'    bu da olur
        ...
        /* bu kismi almadi, yeniden olusturuldu.
        if (flag==0){
